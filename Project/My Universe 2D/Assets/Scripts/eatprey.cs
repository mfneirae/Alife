...
public class eatprey : MonoBehaviour {
    ...
    void Start()
    {
        Age = 0;
        totallife = startlife;
        metabolism = Random.Range(1f, 6f);
        maxage = Random.Range(50f, 120f);
    }
    ...
    void FixedUpdate() 
    {
        ...
        Debug.Log("PREDATOR: Life: " + totallife + ", Age: " + Age + ", Max Age: " + maxage + ", Metabolism: " + metabolism + ", Gen: " + gen);
